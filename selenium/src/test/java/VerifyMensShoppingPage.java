...
public class VerifyMensShoppingPage {

  @Test
  public void testMensShopping() {
    System.setProperty("webdriver.chrome.driver",
        "E:\\Project\\selenium\\src\\test\\resources\\drivers\\chromedriver.exe");
    ...
    String expectedURL = "https://demo.evershop.io/men";
    String actualURL = driver.getCurrentUrl();
    System.out.println(actualURL);
    Assert.assertEquals(expectedURL, actualURL);

    System.out.println("verify colourwise white filteration of items");
    driver.findElement(By.xpath("//*[@id=\"app\"]/div/main/div[3]/div[1]/div/div[3]/ul/li[1]/a/span")).click();
    System.out.println("after applying filter user should see 2 products as white shoes");
